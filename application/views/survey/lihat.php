                                    ...
                                    <div class="form-group">
                                        ...
                                        foreach ($nilai as $row_sub) : ?>
                                            <div class="form-check ml-4 disabled">
                                                <input disabled class="form-check-input" type="radio" name="pertanyaan<?= $row->id_pertanyaan ?>" id="pertanyaan<?= ++$no . $row->id_pertanyaan ?>" value="<?= $row_sub->id_nilai ?>" <?= set_radio('pertanyaan' . $row->id_pertanyaan, $row_sub->id_nilai, $pelanggan_pertanyaan[$row->id_pertanyaan] == $row_sub->id_nilai ? TRUE : FALSE) ?>>
