                    ...
                    <div class="col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <?= form_open('nilai/tambah') ?>
                                <div class="form-group">
                                    <label>Rentang Nilai</label>
                                    <div class="input-group">
                                        <input type="text" name="batas_1" placeholder="Nilai batas 1" class="form-control" value="<?= set_value('batas_1') ?>">
                                        <input type="text" name="batas_2" placeholder="Nilai batas 2" class="form-control" value="<?= set_value('batas_2') ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_nilai" class="form-control" value="<?= set_value('nama_nilai') ?>">
